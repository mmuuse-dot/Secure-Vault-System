...
The system allows secure storage of sensitive files, permission management, vault operations, and security monitoring.
...
- `vault_ops.sh` – Menu-driven vault operations  
- `vault_monitor.sh` – Generates security monitoring report  
- `secure_vault/vault_report.txt` – Generated security report
